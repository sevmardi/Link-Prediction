...
trainPeriod = data[:90000,:]  
testPeriod = data[90000:,:]
...
if not os.path.isdir('MathOverflow'):
    os.mkdir('MathOverflow')

with open('MathOverflow/adamicAdar_MathOverflow.pkl', 'wb') as y:
    pickle.dump(adamicAdarList, y)

with open('MathOverflow/commonNeighbors_MathOverflow.pkl', 'wb') as y:
    pickle.dump(commonNeighborsList, y)

with open('MathOverflow/rootedPageRankList_MathOverflow.pkl', 'wb') as y:
    pickle.dump(rootedPageRankList, y)

with open('MathOverflow/jaccard_MathOverflow.pkl', 'wb') as y:
    pickle.dump(jaccardList, y)

with open('MathOverflow/resAllocation_MathOverflow.pkl', 'wb') as y:
