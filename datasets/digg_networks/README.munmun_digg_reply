Digg network, part of the Koblenz Network Collection
===========================================================================
http://konect.uni-koblenz.de/networks/munmun_digg_reply

This directory contains the TSV and related files of the munmun_digg_reply network:
...
Files: 
    ...
    out.munmun_digg_reply -- The adjacency matrix of the network in space separated values format, with one edge per line
...
@MISC{konect:2016:munmun_digg_reply,
    title = {Digg network dataset -- {KONECT}},
    month = sep,
    year = {2016},
