...
#HTree_1_1 = read.arff('./DiggNetwork//HTree_ROC_DiggNetwork1-1.arff')
#J48_1_1 = read.arff('./DiggNetwork//J48_ROC_DiggNetwork1-1.arff')

HTree_1_10 = read.arff('./DiggNetwork//HTree_ROC_DiggNetwork1-10.arff')
J48_1_10 = read.arff('./DiggNetwork//J48_ROC_DiggNetwork1-10.arff')
...
#     scale_x_continuous(expand = c(0, 0),limits = c(0,1.02)) + scale_y_continuous(expand = c(0, 0), limits = c(0,1.02)) +
#     scale_color_manual(labels = c('C4.5, AUC: 0.8075', 'HTree, AUC: 0.8091'), values = c('red','black')) + 
#     labs(x = 'False Positive Rate', y = 'True Positive Rate (Recall)',title = 'DiggNetwork, Undersampled: 1:1 Ratio') +
