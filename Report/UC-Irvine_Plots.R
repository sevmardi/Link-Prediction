...
#HTree_1_1 = read.arff('./UC-Irvine/HTree_ROC_UC-Irvine1-1.arff')
#J48_1_1 = read.arff('./UC-Irvine/J48_ROC_UC-Irvine1-1.arff')

HTree_1_10 = read.arff('./UC-Irvine/HTree_ROC_UC-Irvine1-10.arff')
J48_1_10 = read.arff('./UC-Irvine/J48_ROC_UC-Irvine1-10.arff')
...
#    scale_x_continuous(expand = c(0, 0),limits = c(0,1.02)) + scale_y_continuous(expand = c(0, 0), limits = c(0,1.02)) +
#    scale_color_manual(labels = c('C4.5, AUC: 0.7865', 'HTree, AUC: 0.784'), values = c('red','black')) +
#    labs(x = 'False Positive Rate', y = 'True Positive Rate (Recall)', title = 'UC-Irvine, Undersampled: 1:1 Ratio') +
