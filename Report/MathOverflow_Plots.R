...
#HTree_1_1 = read.arff('./MathOverflow//HTree_ROC_MathOverflow1-1.arff')
#J48_1_1 = read.arff('./MathOverflow//J48_ROC_MathOverflow1-1.arff')

HTree_1_10 = read.arff('./MathOverflow//HTree_ROC_MathOverflow1-10.arff')
J48_1_10 = read.arff('./MathOverflow//J48_ROC_MathOverflow1-10.arff')
...
# ggplot(data = HTree_1_1, aes(FPR,TPR, color = 'red')) + 
#     geom_line() +
#     geom_line(data = J48_1_1, aes(FPR,TPR, color = 'blue')) +
#     scale_x_continuous(expand = c(0, 0),limits = c(0,1.02)) + scale_y_continuous(expand = c(0, 0), limits = c(0,1.02)) +
#     scale_color_manual(labels = c('C4.5, AUC: 0.8634', 'HTree, AUC: 0.8633'), values = c('red','black')) +
#     labs(x = 'False Positive Rate', y = 'True Positive Rate (Recall)', title = 'MathOverflow, Undersampled: 1:1 Ratio') +
